...
export class MainSceneClass {
    constructor(OriginCameraPosition,video_test) {
        initMainScene();//初始化场景
        this.video_test = video_test//从界面读取视频
    ...
    correctScene(model) {
         ...
         **/
        setTimeout(() => {
            that.CreateVideo(model,this.video_test);
        }, 3000)
        /**
         * @加载用户指示光圈
         */
